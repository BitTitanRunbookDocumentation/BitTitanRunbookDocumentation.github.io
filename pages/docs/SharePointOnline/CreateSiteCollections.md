...
```
    Usage option 1: Create a SharePoint Online site collection
        ...
        ResourceQuota
            Single string, optional.
            The quota for the site collection with default value set as 0. View Microsoft's documentation on New-SPOSite for more information
    ...
    Usage option 2: Creates SharePoint Online site collections
        ...
        SiteCollectionsCsv
            ...
            Optional columns:
                ...
                ResourceQuota
                    The quota for the site collection with default value set as 0.
